      ...
      >
        <div
          ...
          *ngIf="
            ...
            isOpen &&
            (items?.length > 0 ||
              (displayNoResults && !searchActive) ||
              (searchActive && displaySearching))
          "
        >
          <div
...
export class CompleterCmp
  ...
  @ViewChild(CtrCompleter, { static: false }) public completer:
    | CtrCompleter
    | undefined;
  @ViewChild("ctrInput", { static: false }) public ctrInput:
    | ElementRef
    | undefined;
